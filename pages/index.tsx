          ...
          <div className='absolute left-20 top-1/2 -translate-y-1/2 sm:left-1/2 sm:-translate-x-1/2'>
            <svg
              ...
              <path
                ...
                stroke='#fff'></path>
              <path d='M1 279C1 125.465 125.465 1 279 1' stroke='url(#:R1hm:)' strokeLinecap='round'></path>
            </svg>
          </div>
          <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative'>
            <div className='mx-auto max-w-md sm:text-center'>
              <h2 className='font-poppins text-3xl font-medium tracking-tight text-white sm:text-4xl'>
                Únete a la lista de espera para acceso anticipado
              </h2>
              <p className='mt-4 text-lg text-gray-300'>
                Únete a nuestra lista de espera y sé uno de los primeros en disfrutar de la experiencia sin
                complicaciones en los restaurantes con nuestra innovadora aplicación móvil.
              </p>
