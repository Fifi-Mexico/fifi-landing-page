      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        <div className='lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20'>
          <div className='relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6'>
            <h1 className='font-poppins text-4xl font-medium tracking-tight text-gray-900'>
              Mejore su experiencia en restaurantes.
            </h1>
            <p className='mt-6 text-lg text-gray-600'>
              Simplifica el proceso de pedidos en restaurantes con nuestra aplicación móvil. Explora menús, realiza
              pedidos y paga de forma rápida y segura, sin esperas ni complicaciones.
            </p>
          ...
          <div className='relative mt-10 sm:mt-20 lg:col-span-5 lg:row-span-2 lg:mt-0 xl:col-span-6'>
            ...
            <div className='-mx-4 h-[448px] px-9 [mask-image:linear-gradient(to_bottom,white_60%,transparent)] sm:mx-0 lg:absolute lg:-inset-x-10 lg:-bottom-20 lg:-top-10 lg:h-auto lg:px-0 lg:pt-10 xl:-bottom-32'>
              <div className='relative aspect-[366/729] mx-auto max-w-[366px]'>
                ...
                <Image src='/assets/static/screenshot-01.png' alt='hero' width={500} height={500} />
              </div>
            </div>
          </div>
        </div>
